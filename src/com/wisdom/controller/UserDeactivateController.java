 ...
 * @author Helanka
 */
public class UserDeactivateController implements Initializable {

    @FXML
    private AnchorPane anchorPaneUserDeactivate;
    @FXML
    ...
    private void btnSearchOnAction(ActionEvent event) {
        if (!txtLoginID.getText().isEmpty()) {
            ...
            if (loginDAO.getLogin(login)) {
                ...
                alert.setContentText("Invalid LoginID or already deactivate user");
                alert.showAndWait();
            }
