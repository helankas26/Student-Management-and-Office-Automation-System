 ...
 * @author Helanka
 */
public class ClassUpdateController implements Initializable {

    @FXML
    private AnchorPane anchorPaneClassUpdate;
    @FXML
    ...
    @FXML
    private JFXButton btnMakePastClass;
    @FXML
    ...
    @FXML
    private void btnMakePastClassActionPerformed(ActionEvent event) {
    }
