 ...
 * @author Helanka
 */
public class StaffDeactivateController implements Initializable {

    @FXML
    private AnchorPane anchorPaneStaffDeactivate;
    @FXML
    ...
    private void btnSaveOnAction(ActionEvent event) {
        if (!isFieldsEmpty()) {
            ...
            if (staffDAO.insertStaffDeactivate(staff)) {
                setTableView();
                ...
                alert.setContentText("Deactivate staff insert Successfully");
