 ...
 * @author Helanka
 */
public class ClassMakePastController implements Initializable {

    @FXML
    private AnchorPane anchorPaneClassMakePast;
    @FXML
    ...
    @FXML
    private TableView<?> tblClassActive;
    @FXML
    private TableColumn<?, ?> tblClassIDActive;
    @FXML
    private TableColumn<?, ?> tblClassNameActive;
    @FXML
    private TableColumn<?, ?> tblDayActive;
    @FXML
    private TableColumn<?, ?> tblStartTimeActive;
    @FXML
    private TableColumn<?, ?> tblEndTimeActive;
    @FXML
    private TableColumn<?, ?> tblRoomActive;
    @FXML
    private TableColumn<?, ?> tblClassFeeActive;
    @FXML
    private TableColumn<?, ?> tblSubjectIDActive;
    @FXML
    private TableColumn<?, ?> tblTeacherIDActive;
    @FXML
    private TableColumn<?, ?> tblCategoryIDActive;
    @FXML
    ...
    @FXML
    private void tblClassActiveOnMouseClicked(MouseEvent event) {
    }
