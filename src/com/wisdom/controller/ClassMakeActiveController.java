 ...
 * @author Helanka
 */
public class ClassMakeActiveController implements Initializable {

    @FXML
    private AnchorPane anchorPaneClassMakeActive;
    @FXML
    ...
    @FXML
    private JFXButton btnMakeActiveClass;
    @FXML
    ...
    @FXML
    private void btnMakeActiveClassActionPerformed(ActionEvent event) {
    }
