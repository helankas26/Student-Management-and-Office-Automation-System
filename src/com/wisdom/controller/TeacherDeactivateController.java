 ...
 * @author Helanka
 */
public class TeacherDeactivateController implements Initializable {

    @FXML
    private AnchorPane anchorPaneTeacherDeactivate;
    @FXML
    ...
    private void btnSaveOnAction(ActionEvent event) {
        if (!isFieldsEmpty()) {
            ...
            if (teacherDAO.insertTeacherDeactivate(teacher)) {
                setTableView();
                ...
                alert.setHeaderText("Student ID : " + teacher.getUserID());
                alert.setContentText("Deactivate teacher insert Successfully");
    ...
    private void setTableView() {
        ...
        ArrayList<Teacher> teacherList = teacherDAO.getTeacherDeactivate();
